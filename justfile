...
@cifar10_dino_pt_local EXPERIMENT_NAME EPOCHS:
  #!/usr/bin/env bash
...
@cifar10_dino_eval EXPERIMENT_NAME SEED:
  #!/usr/bin/env bash
  mkdir -p /work/dlclarge2/wagnerd-metassl-experiments/dino/CIFAR-10/{{EXPERIMENT_NAME}}/cluster_oe/
...
@cifar100_dino_pt_local EXPERIMENT_NAME EPOCHS:
  #!/usr/bin/env bash
...
@cifar100_dino_pt EXPERIMENT_NAME SEED:
  #!/usr/bin/env bash
...
@cifar100_dino_eval_local EXPERIMENT_NAME EPOCHS:
  #!/usr/bin/env bash
...
@cifar100_dino_eval EXPERIMENT_NAME SEED:
  #!/usr/bin/env bash
  mkdir -p /work/dlclarge2/wagnerd-metassl-experiments/dino/CIFAR-100/{{EXPERIMENT_NAME}}/cluster_oe/
